...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; <a href="#">商品管理</a> &raquo; 添加文章分类
    </div>
    <!--面包屑导航 结束-->
        ...
        <form action="{{url('admin/category/'.$field->cate_id)}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>分类名称：</th>
                    <td>
                        <input type="text" value="{{$field->cate_name}}" name="cate_name">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" value="{{$field->cate_title}}" class="lg" name="cate_title">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" value="{{$field->cate_order}}" class="sm" name="cate_order">
                    </td>
                </tr>
